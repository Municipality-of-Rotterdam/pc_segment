...
Pipelines > pkg_pc_segment > click on three dots in upper right corner > Status badge > Branch: develop > replace this instruction with a Sample markdown.
...
```bash
from pc_segment import multiply
result = multiply(2, 3)
print(result)
```
